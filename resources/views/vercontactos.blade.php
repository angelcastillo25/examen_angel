                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    <p>
                                        <a href="{{ route('directorio.agregarContacto') }}" class="btn btn-primary">Agregar nuevo contacto</a>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <td>{{$item->apellido}}</td>
                                            <td>{{$item->telefono}}</td>
                                            <td><a class="btn btn-danger" href=" {{route('contacto.eliminar', $item->id) }}">Eliminar</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
