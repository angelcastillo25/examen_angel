    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <p>
                    <a href="{{ route('directorio.crearEntrada') }}" class="btn btn-primary">Agregar nuevo</a>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <td>{{$item->apellido}}</td>
                        <td>{{$item->telefono}}</td>
                        <td><a class="btn btn-primary" href="{{ route('directorio.ver', $item->codigoEntrada) }}">Ver</a></td>
                        <td><a class="btn btn-danger" href=" {{route('directorio.eliminar', $item->codigoEntrada) }}">Eliminar</a></td>
                        </tr>
                        @endforeach
                    </tbody>
